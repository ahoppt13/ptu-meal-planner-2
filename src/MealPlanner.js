...
const MEALS = {
  ...
  snack: [
    ...
    { name: "Grenade Protein Bar", cal: 220, protein: 20, carbs: 20, fat: 9, tags: ["no-restrictions"], health: ["low_gi"], allergens: ["dairy","nuts"], recipe: "A convenient high-protein snack bar. Great on the go.", ingredients: [{ item: "Grenade bar", qty: "1" }] },
    { name: "Whey Protein Shake", cal: 120, protein: 24, carbs: 3, fat: 1, tags: ["no-restrictions"], health: ["low_gi","low_sat_fat"], allergens: ["dairy"], recipe: "Mix 1 scoop whey protein with 300ml water or milk. Shake well.", ingredients: [{ item: "Whey protein powder", qty: "1 scoop (30g)" },{ item: "Water or milk", qty: "300ml" }] },
    { name: "Banana & Peanut Butter", cal: 190, protein: 4, carbs: 30, fat: 8, tags: ["no-restrictions","vegan","vegetarian"], health: ["low_sat_fat"], allergens: ["nuts"], recipe: "Peel 1 banana and serve with 1 tbsp peanut butter for dipping.", ingredients: [{ item: "Banana", qty: "1" },{ item: "Peanut butter", qty: "1 tbsp" }] },
    { name: "Rice Cakes with Honey", cal: 130, protein: 1, carbs: 30, fat: 0, tags: ["no-restrictions","vegan","vegetarian"], health: ["low_sat_fat","low_sodium"], allergens: [], recipe: "Top 2 rice cakes with a drizzle of honey.", ingredients: [{ item: "Rice cakes", qty: "2" },{ item: "Honey", qty: "1 tbsp" }] },
